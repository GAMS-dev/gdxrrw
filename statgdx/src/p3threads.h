...
/**** C code included from p3threads.pas(38:1): 57 lines ****/
...
#define FHSEMA(who) ((HANDLE *)(&(who)->P3THREADS_tp3condvar_DOT_hsemaspace))
#define FSSEMA(who) ((HANDLE *)(&(who)->P3THREADS_tp3condvar_DOT_ssemaspace))
...
#  endif
#  if (_POSIX_THREADS < 1)
     /* will this be enough? SOL and SIG are only 1, not higher */
...
typedef struct P3THREADS_tp3condvar_OD_S {  /* Objects of 'tp3condvar' */
  ...
  SYSTEM_integer P3THREADS_tp3condvar_DOT_waitcount;
  P3THREADS_tp3mutex P3THREADS_tp3condvar_DOT_countmux;
  SYSTEM_pointer P3THREADS_tp3condvar_DOT_hsemaspace,P3THREADS_tp3condvar_DOT_ssemaspace;
